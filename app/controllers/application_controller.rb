  ...
  def http_basic_auth
    if Settings.basic_auth
      authenticate_or_request_with_http_basic do |name, password|
        name == "admin" && Digest::SHA512.hexdigest(password) == "52785638ec464fd61f5c9b372797f1a7475225cabeb2b40b2d757eff9b337ff069b2314bb0c0611d44ca5d39c91906ab3415de0fbc36625b970e3c2c03d122da"
      end
    end
  end

module Courses
  class GcseRequirementsForm
    ...
    def equivalency_details_not_given
      accept_gcse_equivalency.present? && !accept_english_gcse_equivalency.present? &&
      !accept_maths_gcse_equivalency.present? && !accept_science_gcse_equivalency.present?
    end

    def secondary_equivalency_details_not_given
      accept_gcse_equivalency.present? && (!accept_english_gcse_equivalency.present? ||
      !accept_maths_gcse_equivalency.present?)
    end
  end
end
